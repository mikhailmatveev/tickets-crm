...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'customer', ref: '#/components/schemas/CustomerSchema'),
        new OA\Property(property: 'replies', items: new OA\Items(ref: '#/components/schemas/TicketReplySchema')),
        new OA\Property(property: 'attachments', type: 'array', items: new OA\Items(ref: '#/components/schemas/MediaResourceSchema'))
    ],
    type: 'object'
)]
class TicketSchema {}
