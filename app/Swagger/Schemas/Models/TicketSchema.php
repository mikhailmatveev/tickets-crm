...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'status', ref: '#/components/schemas/Enum.StatusSchema', default: 'new'),
        ...
        new OA\Property(property: 'customer', ref: '#/components/schemas/Model.CustomerSchema'),
        new OA\Property(property: 'replies', items: new OA\Items(ref: '#/components/schemas/Model.TicketReplySchema')),
        new OA\Property(property: 'attachments', type: 'array', items: new OA\Items(ref: '#/components/schemas/Resource.MediaResourceSchema'))
    ],
    type: 'object'
)]
class TicketSchema {}
